...
{
    public class FromWaitingForConnectionState : StateTransitionTestBase
    {
        [Fact]
        ...
        private WaitingForConnectionState GivenStartingState()
        {
            return new WaitingForConnectionState();
        }
    }
}
