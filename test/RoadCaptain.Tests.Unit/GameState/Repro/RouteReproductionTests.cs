...
namespace RoadCaptain.Tests.Unit.GameState.Repro
{
    public class RouteReproductionTests
    {
        ...
        public void StartingVolcanoClimb()
        {
            ...
            var plannedRoute = routeStore.LoadFrom(Path.Combine("GameState", "Repro", "VolcanoClimbRepro-2.json"));
        ...
        public void ItalianVillaSprintLoopLostRouteLock()
        {
            ...
            var plannedRoute = routeStore.LoadFrom(Path.Combine("GameState", "Repro", "Rebel.Route-Italian.Villa.Sprint.Loop.json"));
