...
namespace RoadCaptain.App.Runner.Tests.Unit.Engine
{
    public class WhenConnectedToZwiftStateIsReceived : EngineTest
    {
        ...
        {
            WindowService.ShowInGameWindow(new InGameNavigationWindowViewModel(new InGameWindowModel(new List<Segment>()), new List<Segment>(), new NopGameConnection(), new NopMonitoringEvents(), new StubWindowService()));
